  ...
  },
  {
    ...
    works: [
      ...
      },
      {
        ...
        year: '2026',
        size: '272mm × 394mm',
        medium: 'Watercolor paint on can tape paper',
        price: 2000000,
        note: [
          "물결이 이르는 곳에 도달하니 물의 잔상만 남았다. 이것이 허'상'일지 환'상'일지 아님, 초'상'일지 모르겠어서 더 마음이 복잡해졌다.",
          // 작가가 끊어 쓴 줄바꿈을 그대로 살린다(.fig-detail-intro 가 pre-line).
